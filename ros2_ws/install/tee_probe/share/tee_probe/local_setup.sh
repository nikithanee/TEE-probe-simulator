...
: ${AMENT_CURRENT_PREFIX:="/uio/hume/student-u78/nikithan/tee_probe_ws/ros2_ws/install/tee_probe"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tee_probe/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tee_probe/environment/path.sh"
